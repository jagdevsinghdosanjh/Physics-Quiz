...
function submitQuiz() {
    ...
    quizData.forEach((q, index) => {
        ...
        Your correct: ${q.options[chosenIndex]}<br>
        Correct correct: ${q.options[correctOption]}<br>
...
function generatePDF() {
    ...
    quizResults.userResponses.forEach((response, index) => {
        ...
        doc.text(`Your correct: ${response.selected}`, 10, y); y += 5;
        doc.text(`Correct correct: ${response.correct}`, 10, y); y += 5;
